...
import socketIoFunction from "./routes/socketIo.js";
// DECLARATIONS
const app = express();
const server = createServer(app); // INITIALIZE THE APP TO SUPPLY HTTP SERVER
...
socketIoFunction(server);  // Initialize socket.io
